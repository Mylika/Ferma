...
class Bottom:
    ...
    def draw(self):
        ...
        pygame.draw.rect(screen, color,
                         (int(self.w * 0.1), int(self.h * 0.85), int(self.w * 0.3), int(self.h * 0.15)))  # панель выбора растения
        pygame.draw.rect(screen, color,
                         (int(self.w * 0.45), int(self.h * 0.85), int(self.w * 0.1), int(self.h * 0.15)))  # мотыга, грабля
        pygame.draw.rect(screen, color,
